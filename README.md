# ember-cli-google-analytics [![Build Status](https://api.travis-ci.org/dresources/ember-cli-google-analytics.svg)](https://travis-ci.org/dresources/ember-cli-google-analytics)
